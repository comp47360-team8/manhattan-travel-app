...
-- 01_create_poi.sql : create tables + insert 5 NYC POIs
-- Run: psql -d offpeak -f db/01_create_poi.sql
-- Sources: data/nyc_busyness.json, data/osm_attractions.json
-- =============================================================
...
-- All core fields sourced from data/nyc_busyness.json and data/osm_attractions.json.
